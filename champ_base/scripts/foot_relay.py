...
class FootRelay:
    def __init__(self):
        ...
        self.left_front_links = rospy.get_param('/foot_relay/left_front')
        self.right_front_links = rospy.get_param('/foot_relay/right_front')
        self.left_hind_links = rospy.get_param('/foot_relay/left_hind')
        self.right_hind_links = rospy.get_param('/foot_relay/right_hind')
    ...
    def foot_callback(self, points):
        ...
        marker_array.markers.append(self.create_marker(points.lf.x, points.lf.y, points.lf.z, 0, self.left_front_links[0]))
        marker_array.markers.append(self.create_marker(points.rf.x, points.rf.y, points.rf.z, 1, self.right_front_links[0]))
        marker_array.markers.append(self.create_marker(points.lh.x, points.lh.y, points.lh.z, 2, self.left_hind_links[0]))
        marker_array.markers.append(self.create_marker(points.rh.x, points.rh.y, points.rh.z, 3, self.right_hind_links[0]))
